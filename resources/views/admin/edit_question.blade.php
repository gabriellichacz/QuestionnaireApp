...
<form action="/poll/{{ $poll->URLslug }}/question/{{ $question->id }}/update" enctype="multipart/form-data" method="post">
    @csrf
    @method('PATCH')
    <div class="row justify-content-center display-6"> {{ __('Edytuj pytanie') }} </div>
        ...
        <div class="col-2">
            ...
            <div class="form-group row">
                ...
                <input name="question" id="question" type="text" class="form-control" 
                    placeholder="Wpisz pytanie" value="{{ $question->question ?? '' }}"> <!-- value old() keeps the old value if there was an error in input -->
